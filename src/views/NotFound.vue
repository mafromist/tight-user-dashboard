<template>
  <main
    class="tw-w-[%80] tw-h-screen tw-bg-white tw-flex tw-flex-col tw-items-center tw-justify-center tw-text-black"
  >
    <svg viewBox="0 0 541.17206 328.45184" width="540" height="330" id="svg2" class="tw-max-w-full">
      <g id="g6219">
        <svg
    ...
    <p class="tw-text-[22px] tw-my-4 tw-text-center">O-o-oh! Something broke.</p>
    <router-link
      to="/"
      class="tw-text-[20px] tw-border tw-border-black tw-py-3 tw-px-6 tw-transition-all tw-duration-500 tw-text-purple-600 hover:tw-bg-purple-600 hover:tw-text-white hover:tw-rounded-xl"
    >
